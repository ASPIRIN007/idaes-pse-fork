...
rts_gmlc_load_dataframe = pd.read_csv(
    os.path.join(this_module_dir, "idc_load_data.csv")
)

rts_gmlc_bus_dataframe = pd.read_csv(
    os.path.join(prescient_5bus, "bus.csv")
)
